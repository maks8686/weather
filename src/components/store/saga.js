...
try{
   const place=yield axios.get(`https://api.openweathermap.org/data/2.5/weather?q=${action.payload}&appid=${apiKey}`)
   ...
   const weather =yield axios.get(`https://api.openweathermap.org/data/2.5/onecall?lat=${lat}&lon=${lon}&exclude={part}&units=metric&lang=ru&appid=${apiKey}`)
   console.log(weather)
